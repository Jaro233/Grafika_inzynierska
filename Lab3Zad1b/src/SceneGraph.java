...
public class SceneGraph extends JPanel {
    ...
    //wielokaty
    public TransformedObject wh11,wh12,wh21,wh22,wh31,wh32;
...
//srodkowa figura
        wh11= (TransformedObject) new TransformedObject(strokedPolygon).setTranslation(-0.90,0.25).setScale(0.005,0.005).setColor(Color.BLACK);
        wh12= (TransformedObject) new TransformedObject(strokedPolygon).setTranslation(0.9,-0.25).setScale(0.005,0.005).setColor(Color.BLACK);

        CompoundObject Swing1 = new CompoundObject();
        Swing1.add(new TransformedObject(filledTriangle).setTranslation(0,-2).setScale(0.7,2).setColor(Color.BLUE));
        Swing1.add(wh11);
        Swing1.add(wh12);
        Swing1.add(new TransformedObject(filledRect).setScale(0.125,2).setRotation(75).setColor(Color.RED));

        world.add(Swing1);
        //------
 //lewa figura
        wh21= (TransformedObject) new TransformedObject(strokedPolygon).setTranslation(-2.75,2.1).setScale(0.004,0.004).setColor(Color.BLACK);
        wh22= (TransformedObject) new TransformedObject(strokedPolygon).setTranslation(-1.27,1.7).setScale(0.004,0.004).setColor(Color.BLACK);

        CompoundObject Swing2 = new CompoundObject();
        Swing2.add(new TransformedObject(filledTriangle).setTranslation(-2,0.5).setScale(0.4,1.4).setColor(Color.MAGENTA));
        Swing2.add(wh21);
        Swing2.add(wh22);
        Swing2.add(new TransformedObject(filledRect).setTranslation(-2,1.9).setScale(0.1,1.7).setRotation(75).setColor(Color.RED));

        world.add(Swing2);

        //------
 //prawa figura
        wh31= (TransformedObject) new TransformedObject(strokedPolygon).setTranslation(1.32,2.18).setScale(0.0032,0.0032).setColor(Color.BLACK);
        wh32= (TransformedObject) new TransformedObject(strokedPolygon).setTranslation(2.67,1.82).setScale(0.0032,0.0032).setColor(Color.BLACK);

        CompoundObject Swing3 = new CompoundObject();
        Swing3.add(new TransformedObject(filledTriangle).setTranslation(2,1).setScale(0.3,1).setColor(Color.GREEN));
        Swing3.add(wh31);
        Swing3.add(wh32);
        Swing3.add(new TransformedObject(filledRect).setTranslation(2,2).setScale(0.08,1.5).setRotation(75).setColor(Color.RED));
    ...
    public void updateFrame() {
        ...
        wh11.setRotation(frameNumber*0.5);
        wh12.setRotation(frameNumber*0.5);

        wh21.setRotation(frameNumber*0.5);
        wh22.setRotation(frameNumber*0.5);

        wh31.setRotation(frameNumber*0.5);
        wh32.setRotation(frameNumber*0.5);
    }
    ...
    //obwod i szprychy dziewieciokata
    private static SceneGraphNode strokedPolygon = new SceneGraphNode()
    {
