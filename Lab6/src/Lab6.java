...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	//Kolor i osw piramidy
		float[] specular = {1.0f,1.0f,1.0f};
	    float[] shininess = {1.0f};
		float[] ambient = {1f,0f,0f,0f};
     ...
     //Ilosc katow w podst piramidy itp
        Pyramid(9,3f,gl2);
	...
	public void init(GLAutoDrawable drawable) {
		...
		gl2.glLightfv(GL2.GL_LIGHT2, GL2.GL_AMBIENT, FloatBuffer.wrap(new float[] {0f,1f,0f,0f}));
